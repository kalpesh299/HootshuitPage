    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 text-center sm:grid-cols-2 gap-y-8 lg:grid-cols-4 sm:gap-12">
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">200,000+</h3>
                <p class="mt-4 text-sm text-gray-600">profetionals trained on product and strategy</p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">45000</h3>
                <p class="mt-4 text-sm text-gray-600">Enterprise User Onboard seamlessly</p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">2500</h3>
                <p class="mt-4 text-sm text-gray-600">enterprise organizations successfully launched</p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Work friendly</h3>
                <p class="mt-4 text-sm text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. </p>
            </div>
        </div>
    </div>
</section>
